 ...
 * * Method named setX with one parameter of type int, it needs to set the value of the x field. * Method named setY
 * with one parameter of type int, it needs to set the value of the y field.
